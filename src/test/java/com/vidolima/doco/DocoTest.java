...
//    	TODO: use logger instead of println
    ...
    /**
     * Test that an Id is autogenerated for object if nul
     */
    @Test
    public void autoGenerateDocumentIfNoId(){
    	ObjectifyEntity obj = new ObjectifyEntity("noID");
    	
    	Doco doco = new Doco();
    	Document document = doco.toDocument(obj);
